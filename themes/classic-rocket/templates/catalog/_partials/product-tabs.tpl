            ...
            {if $product.description}
                <li class="nav-item">
                    <a
                            ...
                            {if $product.description} aria-selected="true"{/if}>{l s='Characteristics' d='Shop.Theme.Catalog'}</a>
                </li>
            {/if}
            <li class="nav-item">
                <a
                        ...
                        {if !$product.description} aria-selected="true"{/if}>{l s='Opinions' d='Shop.Theme.Catalog'}</a>
            </li>
